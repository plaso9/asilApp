...
public class RetrieveBasicNecessitiesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId.setOnClickListener(qrCodeGenerator);
        userId2.setOnClickListener(qrCodeGenerator);
    ...
    public void onBackPressed() {   //Called when the activity has detected the user's press of the back key.
        ...
        Intent intent = new Intent (RetrieveBasicNecessitiesActivity.this, MyInfoActivity.class);
    ...
    public View.OnClickListener qrCodeGenerator = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent qrIntent = new Intent(RetrieveBasicNecessitiesActivity.this, PopUpQrcodeActivity.class);
