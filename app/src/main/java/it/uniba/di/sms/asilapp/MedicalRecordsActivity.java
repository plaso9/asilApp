...
public class MedicalRecordsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_seeHeartbeatStats.setOnClickListener(image_seeHeartbeat_listener);
    ...
    public View.OnClickListener image_seeHeartbeat_listener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent sens = new Intent(MedicalRecordsActivity.this, HomepageActivity.class);
            startActivity(sens);
